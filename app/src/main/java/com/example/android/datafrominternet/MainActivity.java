...
public class MainActivity extends AppCompatActivity {
    ...
    public void showJsonDataView() {
        if (mErrorMessageTextView.getVisibility() == View.VISIBLE) {
            mErrorMessageTextView.setVisibility(View.INVISIBLE);
        }
        if (mSearchResultsTextView.getVisibility() == View.INVISIBLE) {
    ...
    public void showErrorMessage() {
        if (mSearchResultsTextView.getVisibility() == View.VISIBLE) {
            mSearchResultsTextView.setVisibility(View.INVISIBLE);
        }
        if (mErrorMessageTextView.getVisibility() == View.INVISIBLE) {
